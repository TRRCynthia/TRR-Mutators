...
class obygun extends Rx_Weapon_Reloadable;
...
DefaultProperties
{
    ...
    AttachmentClass = class'Attachment_PersonalObeliskCannon'
...
//	PutDownTime=0.75
    ...
    InstantHitDamageTypes(0)=class'Rx_DmgType_Obelisk'
    InstantHitDamageTypes(1)=None

    InstantHitMomentum(0)=30000
    InstantHitMomentum(1)=0

	InstantHitDamageRadius(0)=300
...
//	WeaponDistantFireSnd=SoundCue'RX_WP_PersonalIonCannon.Sounds.SC_PersonalIonCannon_DistantFire'
	...
	BoltReloadSound(0)=SoundCue'RX_BU_Oblisk.Sounds.SC_Obelisk_ChargeUp'
	BoltReloadSound(1)=SoundCue'RX_BU_Oblisk.Sounds.SC_Obelisk_ChargeUp'
